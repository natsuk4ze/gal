...
**If you like this package, Please leave a [like👍](https://pub.dev/packages/gal) and [star⭐️](https://github.com/natsuk4ze/gal) for more features.**
|              | Android | iOS       |
|--------------|---------|-----------|
| **Supports** | SDK 21+ | iOS 11.0+ |
